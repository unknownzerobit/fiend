...
def ip_as_url(ip):
	urls = ["http://howsecureismypassword.net@","http://www.google.com@accounts@","http://www.facebook.com+settings&tab=privacy@","http://www.instagram.com+settings&tab=privacy@","http://www.twitter.com+settings&tab=privacy@","http://www.yahoo.com+settings&tab=privacy@","http://www.paypal.com+settings&tab=privacy@","http://www.netflix.com+settings&tab=privacy@","http://www.pubg.com+settings&tab=privacy@","http://www.youtube.com+settings&tab=privacy@","http://www.spotify.com+settings&tab=privacy@","http://www.covid19.com+tab=privacy@"]
