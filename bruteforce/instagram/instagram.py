...
try:
    color_user=colored("[*]enter Id||Email||phone number: ","red")
    color_service=colored("[*]Enter service(instagram): ","red")
    color_wordlistpath=colored("[*]Enter the path of wordlist: ","red")
    color_delay=colored("[*]Enter the first delay(Recommended 15): ","red")
    color_delay1=colored("[*]Enter the second delay(Recommended 15): ","red")
